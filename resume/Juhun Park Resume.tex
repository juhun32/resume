...
% \resumeItem{Implemented backend features with seamless \textbf{React} integration for frontend functionality, deployed using \textbf{Firebase}.}
\resumeItemListEnd
\resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
\resumeProjectHeading
{\textbf{Web Developer Volunteer, InsightLegi DataStorm '25} $|$ \href{https://github.com/juhun32/datastorm25}{\underline{GitHub}} $|$ React, Bootstrap, Firebase}{November 2024}
\resumeItemListStart
