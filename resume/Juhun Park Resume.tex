...
{\textbf{Project Verstappen} $|$ \href{https://github.com/juhun32/project-verstappen}{\underline{github.com/juhun32/project-verstappen}}}{2024}
\resumeItemListStart
...
\resumeItem{Implemented backend API using Flask to fetch, filter, store, update data from OpenF1 API, with data tables and interactive graphs.}
