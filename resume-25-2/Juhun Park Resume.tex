...
{\textbf{copium} $|$ \href{https://github.com/juhun32/copium}{\underline{GitHub}}} {2024}
{\small{Python, Go, SvelteKit, Tailwind, RabbitMQ, Algolia, Docker, Google Cloud SQL}}
\resumeItemListStart
\resumeItem{Built a \textbf{SvelteKit} tech internship management platform for 350 users that handles live postings and user data with Google Cloud SQL while maintaining \textbf{99\% uptime}, leveraging server-side pagination to decrease data transfer costs by \textbf{50\%}.}
...
\resumeItem{Delivered \textbf{95\%} data freshness for internship searches with a scheduled \textbf{Python} job-posting scraper for Algolia indexing, with \textbf{30\%} reduced operating costs.}
\resumeItemListEnd

\resumeProjectHeading
{\textbf{Project Verstappen} $|$ \href{https://github.com/juhun32/project-verstappen}{\underline{GitHub}}} {2024}
{\small{Python, Shared Memory API, OpenCV, AC/acsys module}}
\resumeItemListStart
\resumeItem{Engineered a real-time telemetry data analysis solution for sim racers with reduced costs by \textbf{30\%}, increased user engagement with telemetry data by \textbf{70\%} by providing more approchable UI/UX for information with steep learning curve.}
...
\resumeProjectHeading
{\textbf{ftrace} $|$ \href{https://github.com/juhun32/f1-statistics}{\underline{GitHub}}} {2024}
