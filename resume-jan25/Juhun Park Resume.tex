...
\resumeItemListStart
\resumeItem{Built core web applications using HTML/CSS, JavaScript, Bootstrap and Oracle DBMS.}
...
\resumeItemListStart
\resumeItem{Coordinated a research project, established and tested a motion detection application utilizing Numpy, OpenCV, PyAutoGUI and MediaPipe.}
