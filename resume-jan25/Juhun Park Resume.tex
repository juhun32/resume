...
\resumeItemListStart
\resumeItem{Developed core web applications using HTML/CSS, JavaScript, Bootstrap and Oracle DBMS.}
...
\resumeItemListStart
\resumeItem{Developed a real-time telemetry data analysis solution for sim racers with reduced costs by \textbf{30\%}, increased user ingagement with telemetry data by \textbf{70\%} by providing more approchable UI/UX for information with steep learning curve.}
