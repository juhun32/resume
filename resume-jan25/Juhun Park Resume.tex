...
\resumeItemListStart
\resumeItem{Developed a real-time telemetry and data analysis system, integrating the Assetto Corsa Shared Memory API and AC/acsys module to extract real-time session telemetry and vehicle data for in-depth analysis.}
