...
\resumeItemThin{\textbf{Frameworks: }{React.js, Flask, Bootstrap, Django, Pandas, Numpy, PostgreSQL, MediaPipe}}\\
...
\resumeItem{Significantly improved application accuracy of the motion-controlled pointer by \textbf{25\%} through optimization of MediaPipe and OpenCV code, resulting in a \textbf{20\%} performance enhancement.}
\resumeItem{Demonstrated strong research and communication skills, authored a comprehensive scientific research paper documenting the project methodology, test results, and potential implications for future research endeavors.}
\resumeItemListEnd
\resumeSubHeadingListEnd
...
\resumeProjectHeading
{\textbf{FO Statistics} | \href{https://github.com/juhun32/f1-statistics}{\underline{GitHub}} | Flask, React, Tailwind CSS, OpenF1 API, FastF1 API, Firebase, Docker, Google Cloud Run} {2025}
\resumeItemListStart
\resumeItem{Built a comprehensive and scalable data platform: Developed a robust backend API using Flask to efficiently fetch, filter, store, and update data from the OpenF1 and FastF1 APIs, enabling the creation of dynamic data tables and informative graphs.}
