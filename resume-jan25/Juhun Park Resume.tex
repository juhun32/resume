...
\resumeItemListStart
\resumeItem{Implemented search, post features and optimized \textbf{React} integration efficiency by \textbf{50\%}, reduced search query response time by \textbf{20\%}.}
...
\resumeItem{Redesigned the frontend using \textbf{React} and \textbf{Bootstrap}, resulting in a \textbf{50\%} reduction in page load time, \textbf{30\%} api fetch time.}
% \resumeItem{Designed and integrated post management features including comments, likes, saves, shares, and favorites.}
\resumeItem{Collaborated as a team of 4 on API testing using \textbf{Postman} and \textbf{cURL}, profile post-related functionality achieved \textbf{98\% accuracy}.}
...
\resumeItemListStart
\resumeItem{Developed skills in web development techniques and \textbf{REST API} using \textbf{Bootstrap}, \textbf{HTML/CSS}, \textbf{JavaScript}, and \textbf{Oracle DBMS}.}
\resumeItem{Acquired backend development skills; object-oriented programming, data structures and algorithms, unit testing, and debugging.}
% \resumeItem{Led a \textbf{team of 4} and improved workflow efficiency by reducing \textbf{30\%} of development time by utilizing \textbf{Git}, \textbf{Github} and \textbf{Notion}.}
\resumeItemListEnd
\resumeSubHeadingListEnd
...
\resumeItem{Increased motion-controlled pointer accuracy by \textbf{25\%} through optimizating \textbf{MediaPipe} and \textbf{OpenCV} code by \textbf{20\%}.}
...
\resumeProjectHeading
{\textbf{Formula One Statistics} $|$ \href{https://github.com/juhun32/f1-statistics}{\underline{GitHub}} $|$ Flask, React, OpenF1 API, FastF1 API, Firebase, Docker, Google Cloud Run}{2025}
\resumeItemListStart
\resumeItem{Implemented backend API using \textbf{Flask} to fetch, filter, store, update data from OpenF1 API and FastF1 API, with data tables, graphs.}
...
\resumeItem{Deployed the backend API on \textbf{Google Cloud Run} using \textbf{Docker} for containerization, and \textbf{Firebase} for react frontend.}
\resumeItemListEnd
