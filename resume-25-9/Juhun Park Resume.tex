...
\resumeItemListStart
\resumeItem{Developing a scalable \textbf{Next.js, Node.js, RESTful APIs} dashboard that manages event details and meeting schedules.}
\resumeItem{Leading a community of \textbf{50+} developers; running \textbf{Agile} sprints with GitHub to deliver 2 full-stack products for GMU.}
...
{Software Engineer Intern} {Remote}
\resumeItemListStart
\resumeItem{Implemented \textbf{JWT} for Google OAuth, refactored \textbf{Django} service into modular apps, improving API throughput by \textbf{30\%}.}
\resumeItem{Wrote unit tests with \textbf{Pytest}, increasing CRUD API test coverage from \textbf{20\%} to \textbf{85\%}, caught \textbf{2} critical issues pre-launch.}
\resumeItemListEnd
\resumeSubHeadingListEnd
...
% \resumeItemListStart
% \resumeItem{Redesigned a local dental office website with \textbf{Next.js}, improved Lighthouse performance score from 75 to 95.}
...
\resumeItem{Optimized \textbf{Firestore} access patterns to keep API latency \textbf{sub-150ms}, handling \textbf{1k+} daily API requests.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Implemented a real-time Assetto Corsa telemetry pipeline, streamed events to \textbf{Kafka} for web based interactive analysis.}
\resumeItemListEnd
\resumeSubHeadingListEnd
...
\resumeItemThin{\textbf{Frameworks: } React, \textbf{Node.js}, Django, Flask, Next.js, SvelteKit, FastAPI, .NET, PostgreSQL}\\
