...
\resumeSubHeadingListStart
\resumeSubheading
{Google Developer Groups} {Apr 2025 - Present}
...
\resumeItem{Improved compared to previous, \textbf{FCP} 1.9s to 0.9s, \textbf{LCP} 6.4s to 2.2s, \textbf{TBT} 130ms to 30ms, \textbf{Speed Index} 2.7s to 0.9s.}
\resumeItemListEnd
