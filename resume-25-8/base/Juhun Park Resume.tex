...
\resumeItemListStart
\resumeItem{Led GDG community of \textbf{50+} members; scoped goals, set milestones, and ran launch reviews using Git and Agile cycles.}
\resumeItem{Directed 4 cross-functional teams in sprint planning and task distribution across full-stack and CI/CD pipelines.}
\resumeItem{Contributed to core development of a scalable dashboard, enabling future members to reduce onboarding time by 30\%.}
\resumeItemListEnd
\resumeSubHeadingListEnd
...
\resumeItem{Designed \textbf{PostgreSQL schema and SQL functions} on \textbf{Supabase}, with performant query execution time of \textbf{sub-5ms}.}
