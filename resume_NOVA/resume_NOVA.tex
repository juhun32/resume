...
\section{Projects}
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
            {\textbf{Portfolio Template Website} $|$ \href{https://github.com/juhun32/portfolio-template-project}{\underline{GitHub Demo}}}{April 2024 -- May 2024}
            % $|$ \emph{HTML, CSS, JavaScript, Git} 
            \resumeItemListStart
                \resumeItem{Technologies Utilized: HTML, CSS, JavaScript, Git}
...
\section{Experience \& Activities}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            ...
            \resumeItemListStart
                \resumeItem{Back-end development course, consisted of basic Java, Oracle DBMS}
            \resumeItemListEnd
        \resumeSubHeadingListEnd
