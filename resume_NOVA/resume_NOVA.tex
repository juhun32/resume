...
\resumeItem{Developed a frontend interface with React for users to navigate through updated driver standings and statistics.}
\resumeItemListEnd
...
\resumeItem{Developed a functional calculator that mimics iOS design and functionality, with 1:1 scale ratio and same coloring.}
\resumeItem{Implemented responsive design techniques to ensure optimal user experience across desktops, tablets, and mobile devices.}
\resumeItemListEnd
